...
## Aula 2
- Apresentação e discussões de ferramentas e ambiente Github
  -Criação da conta 
  - Criação de repositório 
  - Objetivos
## Aula 1
- Apresentação do plano de aula
-  Apresentação e discussão de conceitos bãsicos 
   - Sistemas (O que é, pra que server, quando usar)
   - Elementos que compõem um sistema
   - aspectos estruturais: caracteristicas de um sistema
